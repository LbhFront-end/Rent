<template>
  <div class="main flex-x-center flex-y-center flex-col">
      <!-- 已支付-付款明细 -->
      <div class="paymentRecordPayY flex-x-center flex-y-center flex-col" v-for="item in payList" :key="item.id">
          <!-- 标题 -->
        ...
        <!-- 确认支付 -->
        <!-- <div class="ConfirePayment flex-col flex-x-center flex-y-center">
        <p>提交支付</p>
        </div>         -->
      </div>
  </div>
